...
from ovi.utils.custom_offloading_utils import ModelOffloader, _clean_memory_on_device
...
class WanModel(ModelMixin, ConfigMixin):
    ...
    def forward(
        ...
        for block_idx, block in enumerate(self.blocks):
            is_block_skipped = False  # Ovi doesn't have block skipping like Wan2.2
